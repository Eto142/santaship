...
<head>
    ...
    <meta name="description" content="Santaship Logistics Company Limited – Shipment Tracking">
    <title>Track Your Shipment | Santaship Logistics Company Limited</title>
    ...
    <style>
        ...
        *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .hero-badge {
            ...
            text-transform: uppercase;
            margin-bottom: 20px;
            box-shadow: 0 6px 20px rgba(232,146,10,.4);
        }
        .tracking-hero h1 {
            font-family: 'Rajdhani', sans-serif;
        ...
        .info-header i { color: var(--accent-light); font-size: 1rem; }
        ...
        .sub-heading i { color: var(--accent); }
        ...
        .timeline-dot {
            ...
            font-size: .9rem;
            z-index: 2;
            box-shadow: 0 3px 10px rgba(232,146,10,.25);
            flex-shrink: 0;
        }
        .timeline-content {
            flex: 1;
        ...
        .route-pin.dest   { background: var(--success); color: var(--white); }
        .route-label { font-size: .75rem; color: var(--text-muted); text-transform: uppercase; letter-spacing: .5px; }
        .route-name { font-weight: 700; color: var(--primary); }
...
<div class="track-topbar no-print">
    <div class="container">
        <div class="track-topbar-inner">
            <a href="{{ url('/') }}" class="track-logo" aria-label="Santaship Logistics Home">
        ...
        <div>
            ...
            <div class="info-card" id="live-map-card">
                <div class="info-header" style="justify-content:space-between;">
                    ...
                    <span id="map-status-badge" style="font-size:.75rem; font-weight:600; background:rgba(232,146,10,.15); color:var(--accent-light); padding:4px 12px; border-radius:50px; display:flex; align-items:center; gap:6px;">
